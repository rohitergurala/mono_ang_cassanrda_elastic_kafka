...
@RestController
@RequestMapping("/api/mono-ang-cass-elastic-kafka-kafka")
public class MonoAngCassElasticKafkaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MonoAngCassElasticKafkaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MonoAngCassElasticKafkaKafkaResource(KafkaProperties kafkaProperties) {
